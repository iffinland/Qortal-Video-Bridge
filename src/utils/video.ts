...
export const buildEmbedCode = (
  video: Pick<VideoMetadata, 'qdn' | 'publisher' | 'title' | 'localFilename'>
) => {
  ...
  <video controls preload="metadata" src="${qdnPath}" style="width: 100%; max-width: 960px; border-radius: 8px; background: #000;"></video>
